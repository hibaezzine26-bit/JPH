...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            ...
            // Ignore token validation exceptions to allow permitAll endpoints to be accessible
            // Spring Security will automatically handle access control for protected routes
        }
